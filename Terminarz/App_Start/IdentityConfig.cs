...
namespace Terminarz
{
    ...
    public class UzytkownikManager : UserManager<Uzytkownik>
    {
        ...
        {
            var manager = new UzytkownikManager(new UserStore<Uzytkownik>(context.Get<TerminarzContext>()));
        ...
        internal Task CreateAsync(Uzytkownik user, string password, string imie, string nazwisko)
        {
